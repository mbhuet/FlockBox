...
#if UNITY_EDITOR
                    if (containment.DebugSteering) Debug.DrawRay(agent.GetWorldPosition(in ltw), AgentData.FlockToWorldDirection(in ltw, in ltp, steer), containment.DebugColor, 0, true);
#endif
