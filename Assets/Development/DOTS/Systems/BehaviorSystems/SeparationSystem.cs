...
{
    [BurstCompile]
    struct SeparationJob : IJobForEach<Acceleration, NeighborData, SeparationData>
    {
        public float dt;


        public void Execute(ref Acceleration c0, ref NeighborData c1, ref SeparationData sep)
        {
