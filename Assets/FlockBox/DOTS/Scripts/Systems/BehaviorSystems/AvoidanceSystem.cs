...
#if UNITY_EDITOR
                    if (avoidance.DebugSteering) Debug.DrawRay(agent.GetWorldPosition(in ltw), AgentData.FlockToWorldDirection(in ltw, in ltp, steer), avoidance.DebugColor, 0, true);
#endif
