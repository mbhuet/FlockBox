...
namespace CloudFine.FlockBox
{
    public class PlanetoidSteeringAgent : SteeringAgent
    {
        protected override void UpdateTransform()
        {
            ...
            Vector3 planetoidCenter = myNeighborhood.WorldDimensions/2f;
            float planetoidRadius = Mathf.Min(myNeighborhood.WorldDimensions.x, myNeighborhood.WorldDimensions.y, myNeighborhood.WorldDimensions.z)/2f;
            ///////
