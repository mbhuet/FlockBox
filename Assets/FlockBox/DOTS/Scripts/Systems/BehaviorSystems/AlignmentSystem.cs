...
#if UNITY_EDITOR
                    if (alignment.DebugSteering) Debug.DrawRay(agent.GetWorldPosition(in ltw, in ltp), AgentData.FlockToWorldDirection(in ltw, in ltp, steer), alignment.DebugColor, 0, true);
#endif
